# 08 Pokémon totals and averages without a loop

import numpy as np

# A list of 720 Pokémon called names.
...
# Each row of stats corresponds to a Pokémon in names and each column represents an individual Pokémon stat (HP, Attack, Defense, Special Attack, Special Defense, and Speed respectively.)
...
# If you were to gather run times, the for loop would have taken milliseconds to execute while the NumPy approach would have taken microseconds to execute.
